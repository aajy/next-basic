...
/*
  ...
  3. quality속성으로 직접 최적화가능 0~100(default:75)
  4. priority속성을 이용해서 빨리 출력해야 되야되는 이미지에 우선순위를 부여가능
  5. 기본적으로 Image 컴포넌트는 lazy loading기능을 적용하는데 priority 적용시 lazy loading 기능은 강제 해제됨(주의)
